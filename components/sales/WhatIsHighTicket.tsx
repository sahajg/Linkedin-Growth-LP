...
export function WhatIsHighTicket() {
    return (
        <section className="section-padding" style={{ width: "100%", backgroundColor: "#0F1014", borderTop: "1px solid #1f2026" }}>
            <div className="section-inner high-ticket-grid">
                ...
                <div>
                    ...
                    {/* Qualification badge */}
                    <div style={{ display: "inline-flex", alignItems: "center", gap: "8px", backgroundColor: "rgba(34,197,94,0.1)", border: "1px solid rgba(34,197,94,0.3)", borderRadius: "999px", padding: "6px 16px", marginBottom: "28px" }}>
                        <div style={{ width: "7px", height: "7px", borderRadius: "50%", backgroundColor: "#22c55e" }} />
                        <span style={{ fontSize: "12px", fontWeight: 700, color: "#22c55e", letterSpacing: "0.12em" }}>
                            Sound familiar? Keep reading.
                        </span>
                    </div>
                    <div style={{ display: "flex", flexDirection: "column", gap: "18px", fontSize: "17px", color: "rgba(255,255,255,0.7)", lineHeight: 1.7, fontWeight: 500 }}>
                        ...
                        <p>You&apos;t need another marketing tactic that sounds good on paper. You need a repeatable pipeline that puts qualified buyers in front of you every single month.</p>
                    </div>
                </div>
                    ...
                    <ul style={{ display: "flex", flexDirection: "column", gap: "18px", listStyle: "none", padding: 0, margin: 0 }}>
                        {benefits.map((benefit, index) => (
                            <li key={index} style={{ display: "flex", alignItems: "flex-start", gap: "14px" }}>
                                ...
                                <span style={{ fontSize: "16px", color: "rgba(255,255,255,0.85)", fontWeight: 600, lineHeight: 1.5 }}>{benefit}</span>
                            </li>
                        ))}
                    </ul>
                </div>
